package tech.jour.template.base.utils.status.imp

import android.os.Bundle
import tech.jour.template.base.utils.status.ViewStatusHelper
...
open class BaseFrameViewStatusHelperImp(parentViewStatusHelper: ViewStatusHelper? = null) : ViewStatusHelper(parentViewStatusHelper) {
     ...
     */
    private val KEY_RECREATE = "tech.jour.template.base.utils.status.BaseFrameViewStatusHelperImp.Recreate"
